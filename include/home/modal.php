    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form action="cart/data.php?q=checkout" method="POST">
            ...
            <div class="form-group">
                <label>Contact #</label>
                <input type="text" name="contact" class="form-control" placeholder="(ex. 096 579 5229)" required>
            </div>
            <div class="form-group">
                <label>Email</label>
            ...
            <div class="form-group">
                ...
                <textarea  name="address" class="form-control" rows="4" required>(ex. 2/F San Jose St., Brgy. Banga, Syudad City) </textarea>
            </div>
