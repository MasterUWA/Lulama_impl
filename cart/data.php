...
class Shopping {
    ...
    function countorder(){
        $q = "select * from icecream_db.order where status='unconfirmed'";
        $result = mysql_query($q);
        echo mysql_num_rows($result);
    }
    function countproducts(){
        $q = "select * from icecream_db.products";
        $result = mysql_query($q);
        echo mysql_num_rows($result);
    }
    function countcategory(){
        $q = "select * from icecream_db.category";
        $result = mysql_query($q);
        echo mysql_num_rows($result);
    }
    function checkout(){
        ...
        echo $q = "INSERT INTO icecream_db.order VALUES (NULL, '$fullname', '$contact', '$address', '$email', '$item', '$amount', 'unconfirmed', '$date', '')";
    ...
    function verify(){
        ...
        $q = "SELECT * from icecream_db.user where username='$username' and password='$password'";
        $result = mysql_query($q);
        $_SESSION['login']='yes';
        echo mysql_num_rows($result);
    }
